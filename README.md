...
- поиск сотрудников в AI-чате по подтверждённым результатам анкет;
...
Имена и логины сотрудников в модель не передаются: модель работает с обезличенными
ID и подтверждёнными ответами, а приложение загружает данные сотрудников из БД
после завершения AI-вызова.
