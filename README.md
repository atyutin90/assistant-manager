...
├── anketa/               # анкеты сотрудников и проверка ответов
...
| `anketa` | Прохождение анкет и проверка ответов                                       | `USER`, `TEAM_LEAD` |  `8890` |
...
| Anketa | `backend1`  | `1111`  | `USER` |
| Anketa | `backend2`  | `1111`  | `USER`, `TEAM_LEAD` |
| Anketa | `analyst1`  | `1111`  | `USER`|
| Anketa | `analyst2`  | `1111`  | `USER`, `TEAM_LEAD`|
| Anketa | `devops1`   | `1111`  | `USER`|
| Anketa | `devops2`   | `1111`  | `USER`, `TEAM_LEAD`|
| Anketa | `frontend1` | `1111`  | `USER`|
| Anketa | `frontend2` | `1111`  | `USER`, `TEAM_LEAD`|
| Anketa | `autoqa1`   | `1111`  | `USER`|
| Anketa | `autoqa2`   | `1111`  | `USER`, `TEAM_LEAD`|
| Anketa | `qa1`       | `1111`  | `USER`|
| Anketa | `qa2`       | `1111`  | `USER`, `TEAM_LEAD`|
...
```bash
docker build -f anketa/Dockerfile -t assistant-anketa .
