...
public class UserDtoConverter {
    ...
    public static UserDto dtoOf(User data) {
        return UserDto.builder()
            ...
            .responsibleIds(responsibleIdsOf(data))
    ...
    private static Set<Long> responsibleIdsOf(User data) {
        return isNotEmpty(data.getResponsibles()) ?
            data.getResponsibles().stream().map(User::getId).collect(toSet()) :
            Set.of();
    }
