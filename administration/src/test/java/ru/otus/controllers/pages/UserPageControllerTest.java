...
public class UserPageControllerTest {
    ...
    void shouldRenderUserEditPage() throws Exception {
        ...
        when(userTechnologyService.findAll(any(), any())).thenReturn(new PageImpl<>(List.of()));
        ...
        mvc.perform(get("/users/1"))
            ...
            .andExpect(model().attributeExists(PASSWORD_CHANGE, TEAM_LEADS, CAREER_LEVELS, USER_ROLES, "userTechnologies"));
    }
