...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(StaffEvaluationStatusException.class)
    public ModelAndView handleStaffEvaluationStatusException(StaffEvaluationStatusException exception) {
        var modelAndView = new ModelAndView("error/error-page");
        modelAndView.addObject("message", exception.getMessage());
        modelAndView.addObject("status", CONFLICT.value());
        return modelAndView;
    }
